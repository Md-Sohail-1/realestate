...
const About = () => {
  return (
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 flex-wrap">
    ...
    <div className="flex-1 min-w-[300px] px-0 md:py-6 text-center">
      <img loading="lazy" src={realEstateImage} alt="Real Estate" className="w-full max-w-md mx-auto rounded-xl shadow-md"/>
    </div>

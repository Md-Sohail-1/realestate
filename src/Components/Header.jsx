  ...
  return (
    <>
      ...
      <header className="fixed top-0 w-full bg-slate-100 h-16 flex items-center text-blue-600 z-30 px-4 md:px-6 lg:px-10 shadow-sm" >
        <h1 className="text-2xl uppercase block md:w-1/3 lg:w-96 px-2 md:px- lg:px-12 font-bold">Prime Estate</h1>
        ...
        <nav className="absolute left-0 md:px-0 lg:px-12 py-6 md:py-0 w-full -top-[100vh] bg-slate-200 rounded-b-xl flex flex-col justify-start gap-0 shadow-md transition-all md:static md:flex-row md:h-auto md:justify-end md:gap-8 md:shadow-none md:bg-transparent">
          <h2 className="px-6 mt-5 mb-4 text-xl capitalize text-indigo-600 block md:hidden font-bold">Prime Estate</h2>
          <ul className="flex px-6 md:px-0 flex-col justify-evenly pb-2 md:flex-row md:justify-end md:gap-2 md:p-0 md:text-right">

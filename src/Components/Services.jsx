...
const Services = () => {
  ...
  return (
    <section id="services" className="w-full bg-slate-100 px-4 sm:px-6 md:px-8 lg:px-12 pt-28 pb-16 md:pb-20 relative">
      <h3 className="absolute font-bold top-12 left-1/2 -translate-x-1/2 w-[300px] max-w-content text-3xl sm:text-3xl md:text-4xl md:w-[500px] text-center text-slate-700 z-20">Services We Offer</h3>  
      <div className="flex mx-auto max-w-6xl flex-wrap px-2 gap-4 md:gap-6 justify-center items-center">
        {

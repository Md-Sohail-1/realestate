...
const ServiceCard = ({heading, desc, link, btnValue, imageUrl}) => {
  return (
    <>
    <div className="md:max-h-96 md:min-h-96 p-6 px-6 flex flex-col justify-center items-center text-center gap-2 transition-all duration-100 rounded-xl opacity-100 scale-100 shadow-[0_0_2px_rgba(1,1,1,0.2)] bg-slate-200 hover:bg-slate-200 max-w-sm w-full">
